    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <div class="grid-content1 bg-purple">
          <el-carousel :interval="4000" indicator-position="outside" height="200px" style="background-color: #d3dce6">
    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <div class="grid-content bg-purple">
          <el-form :inline="true" :model="formInline" class="demo-form-inline" ref = "formInline" style="padding-top: 15px;padding-left: 5px" >
            <el-form-item >
          ...
          <div v-if="activeDiv === 'A'" style="padding-left: 5px">
            <el-table
                :data="tableData"
                border
                style="width: 100%">
          ...
          <div v-if="activeDiv === 'D'" style="padding-left: 5px;padding-right: 5px">
            <el-table
                :data="tableData2"
                border
                style="width: 100%">
